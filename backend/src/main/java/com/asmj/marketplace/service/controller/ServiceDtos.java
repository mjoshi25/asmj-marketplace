...
public class ServiceDtos{
 ...
 public record BookingRequest(String serviceId,String packageId,LocalDate serviceDate,LocalTime startTime,String customerName,String customerMobile,String address,String city,String landmark,String notes,String discountCode){}
