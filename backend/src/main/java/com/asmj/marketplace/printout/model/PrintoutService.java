...
public class PrintoutService { @Id private String id; private String vendorId, serviceName, description; private boolean pickupAvailable, homeDeliveryAvailable, active; private String approvalStatus; private BigDecimal minimumHomeDeliveryAmount, homeDeliveryChargePercent, bwSingleRate, bwDoubleRate, colorSingleRate, colorDoubleRate, a3AdditionalCharge, bindingCharge, laminationCharge; private Instant createdAt,updatedAt; }
